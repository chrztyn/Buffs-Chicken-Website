<template>
    <div 
        class="menu-card bg-white rounded-2xl p-3 flex flex-col shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-gray-200 group"
    >
        <!-- Image Section -->
